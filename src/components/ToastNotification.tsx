...
export const ToastNotification: React.FC = () => {
  ...
  return (
    <aside
      aria-label="Notificación de texto copiado"
      id="global-copy-toast"
      className="fixed bottom-20 left-1/2 -translate-x-1/2 z-50 max-w-sm w-[90%] sm:w-auto bg-slate-900/95 text-white px-4 py-2.5 rounded-2xl shadow-2xl border border-slate-700/80 backdrop-blur-md flex items-center justify-between gap-3 transition-all duration-200 animate-in fade-in slide-in-from-bottom-3"
    >
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs font-medium text-slate-200 truncate max-w-[200px] sm:max-w-[260px]">
            {toast.text}
          </p>
        </div>
      </div>
